package com.example.administrator.headdemo;
...
public class UpLoadUtils {
    ...
    public static void main(String[] args) {
        try {
            ...
            new UpLoadUtils().uploadForm(null, "uploadFile", file, "helloworld.txt",
                    "http://localhost:8080/strurts2fileupload/uploadAction");

            new UpLoadUtils().uploadFromBySocket(null, "uploadFile", file,
